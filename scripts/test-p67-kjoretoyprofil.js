...
assert(sw.includes("CACHE_VERSION = 'bilpark-v117'"), 'sw.js v117');
assert(/const APP_VERSION = 117/.test(vc), 'APP_VERSION 117');
assert(/"version":\s*"117"/.test(vj), 'version.json 117');
