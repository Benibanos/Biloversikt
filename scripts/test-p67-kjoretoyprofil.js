...
assert(sw.includes("CACHE_VERSION = 'bilpark-v118'"), 'sw.js v118');
assert(/const APP_VERSION = 118/.test(vc), 'APP_VERSION 118');
assert(/"version":\s*"118"/.test(vj), 'version.json 118');
