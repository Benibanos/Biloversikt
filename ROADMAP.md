...
Sist oppdatert: 2026-09-25 (Fase 1B migreringskode FULLFØRT i appen — manuell kjøring gjenstår for administrator. Appversjon 132, storage v2.26.0. 14 dagers kompatibilitet starter når migreringen er kjørt. Fase 2 / flåtehelse / datakvalitetsmotor er ikke startet).
...
**Fase 1B — migreringskode levert (appversjon 132).** Feltene er aktive. Administrator: (1) opprett manglende 1B-kolonner om de mangler, (2) Synkroniser nå, (3) Optimaliseringer → Airtable → «Kjør migrering». Deretter 14 dagers kompatibilitet med dobbeltskriving. Ikke start Fase 2, flåtehelse eller datakvalitetsmotor. Sjekkliste: `AIRTABLE_MIGRATION.md`.
