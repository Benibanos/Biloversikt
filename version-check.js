  ...
  const VERSION_CHECK = {
    ...
    showUpdatePanel: function(serverVersion, clientVersion) {
      ...
      if (!panel) {
        ...
        panel.innerHTML = '<div style="width:min(100%,460px);padding:28px;text-align:left;border:1px solid #F0554F;border-radius:14px;background:#101614;box-shadow:0 18px 50px rgba(0,0,0,.35)"><div style="text-align:center;margin-bottom:20px"><img src="icons/bilpark-icon-192-v63.png" alt="Bilpark" style="width:72px;height:72px;display:block;margin:0 auto 10px;border-radius:16px"><div style="font-size:18px;font-weight:700;letter-spacing:.04em">BILPARK</div></div><div style="font-size:24px;font-weight:700;color:#F0554F;margin-bottom:16px">⚠️ Oppdatering kreves</div><p>Denne enheten kjører en eldre versjon av Bilpark.</p><p>For å sikre at kilometerstander, kontroller, skader og aktive saker behandles korrekt må sjåførkontrollen oppdateres før den kan brukes.</p><h2 style="font-size:16px;margin:20px 0 8px">Versjonsstatus</h2><p id="version-info" style="margin:0 0 18px;color:#C3CFC8"></p><p>Du kan ikke registrere:</p><ul><li>Sjåførkontroller</li><li>Skader</li><li>Varsellamper</li><li>Avvik</li><li>Kommentarer</li></ul><p>før oppdateringen er fullført.</p><p>Trykk på knappen under for å laste ned siste versjon av Bilpark.</p><button id="version-update-btn" type="button" style="padding:10px 16px;border:0;border-radius:9px;background:#19A66B;color:#08100C;font-weight:700;cursor:pointer">🔄 Oppdater sjåførkontrollen</button><p style="margin:20px 0 0;color:#C3CFC8;font-size:13px">Hvis problemet vedvarer, kontakt driftskoordinator.</p></div>';
    ...
    showVerificationError: function() {
      ...
      if (!panel) {
        ...
        panel.id = 'version-update-panel';
        panel.style.cssText = 'position:fixed;inset:0;z-index:2147483647;display:flex;align-items:center;justify-content:center;padding:24px;background:#080C0B;color:#E9F0EC;font:16px system-ui,sans-serif;text-align:center;';
        panel.innerHTML = '<div style="width:min(100%,460px);padding:28px;text-align:left;border:1px solid #F0554F;border-radius:14px;background:#101614;box-shadow:0 18px 50px rgba(0,0,0,.35)"><div style="text-align:center;margin-bottom:20px"><img src="icons/bilpark-icon-192-v63.png" alt="Bilpark" style="width:72px;height:72px;display:block;margin:0 auto 10px;border-radius:16px"><div style="font-size:18px;font-weight:700;letter-spacing:.04em">BILPARK</div></div><div style="font-size:24px;font-weight:700;color:#F0554F;margin-bottom:16px">⚠️ Kunne ikke verifisere versjon</div><p>Bilpark fikk ikke bekreftet at denne enheten kjører siste godkjente versjon.</p><p>For å beskytte kjøretøydata og kontrollhistorikk er sjåførkontrollen midlertidig sperret.</p><p>Kontroller internettilkoblingen og prøv igjen.</p><button id="version-update-btn" type="button" style="padding:10px 16px;border:0;border-radius:9px;background:#19A66B;color:#08100C;font-weight:700;cursor:pointer">🔄 Prøv igjen</button><p style="margin:20px 0 0;color:#C3CFC8;font-size:13px">Hvis problemet vedvarer, kontakt driftskoordinator.</p></div>';
        document.body.appendChild(panel);
